...
if __name__ == "__main__":
    ...
    AOI_DATASET_SHPFILE = cfg['datasets'].get('aoi_dataset')
    # swimming pools
    ...
    if AOI_DATASET_SHPFILE is not None:
        logger.info("Loading AoI dataset specified in the configuration file...")
        aoi_gdf = gpd.read_file(AOI_DATASET_SHPFILE)
        logger.info(f"...done. {len(aoi_gdf)} records were found.")
    else:
        aoi_gdf = pd.concat([
